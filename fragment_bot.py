...
async def on_connect(msg: types.Message):
    ...
    try:
        ...
        # 6) Wait for the Connect button to disappear (handshake)
        try:
...
# ─── /logout & inline-query remain unchanged ─────────────────────────────────────
...
async def main():
    ...
    logging.info("🤖 Bot started — /connect, /logout; inline → digits.")
